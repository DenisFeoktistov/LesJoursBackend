"""
URL configuration for lesjours project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="LesJours API",
        default_version='v1',
        description="API for LesJours masterclasses platform",
        terms_of_service="https://www.lesjours.com/terms/",
        contact=openapi.Contact(email="contact@lesjours.com"),
